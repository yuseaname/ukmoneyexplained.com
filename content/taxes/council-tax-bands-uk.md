...
Let us calculate the cost for a Band A property.
First, divide the Band D bill by 9 to find the value of one unit.
£1,800 ÷ 9 = £200 per unit.

Next, multiply by the fraction for Band A, which is 6.
£200 × 6 = £1,200.

Now, let us calculate the cost for a Band H property.
Multiply the unit value by the fraction for Band H, which is 18.
£200 × 18 = £3,600.
...
| Item | Value (England & Wales) | Notes |
| :--- | :--- | :--- |
| **Band A** | Up to £40,000 | Lowest tax band. |
| **Band B** | £40,001 to £52,000 | Slightly higher than A. |
| **Band C** | £52,001 to £68,000 | Mid-range lower band. |
| **Band D** | £68,001 to £88,000 | The standard reference band. |
| **Band E** | £88,001 to £120,000 | Mid-range upper band. |
| **Band F** | £120,001 to £160,000 | Higher value properties. |
| **Band G** | £160,001 to £320,000 | High value properties. |
| **Band H** | Over £320,000 | Highest tax band. |
