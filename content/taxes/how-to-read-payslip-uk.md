---
title: "How to Read a UK Payslip: Complete Guide with Examples"
description: "Understand every line on your UK payslip: gross pay, tax code, income tax, National Insurance, pension, student loans, and net pay. Learn what to check and common errors to spot."
date: 2026-08-09
lastmod: 2026-08-09
draft: false
tags: ["tax", "income-tax", "national-insurance", "pension"]
format: step-by-step
quick_answer:
  - "Understand every line on your UK payslip: gross pay, tax code, income tax, National Insurance, pensi…"
  - "Follow the process below to read a uk payslip: complete guide with examples."
---

> **Quick answer:** Your UK payslip shows your gross pay, deductions (income tax, National Insurance, pension, student loan), and net (take-home) pay. The most important thing to check is your **tax code** — if it's wrong, you're paying the wrong amount of tax. The standard code for 2025/26 is **1257L**, meaning you get the £12,570 Personal Allowance tax-free. Source: [GOV.UK — Check your tax](https://www.gov.uk/check-income-tax-current-year).
...
### 1. Personal Details
Your name, address, National Insurance number, and payroll number. Check your NI number is correct — errors here can cause problems with your [State Pension](/pension-auto-enrolment-uk-explained/) and tax records.
...
If your tax code is wrong, you could be paying hundreds of pounds too much or too little. Check your code at [GOV.UK — Check your Income Tax](https://www.gov.uk/check-income-tax-current-year).

Read our full guide on [income tax bands](/income-tax-bands-uk-explained/) for how tax is calculated at each rate.

### 5. Income Tax Deduction
The amount of income tax deducted via PAYE (Pay As You Earn). This is calculated based on your tax code and the [income tax bands](/income-tax-bands-uk-explained/):

- **20%** on earnings between £12,571 and £50,270
- **40%** on earnings between £50,271 and £125,140
- **45%** on earnings above £125,140

Use our [income tax calculator](/income-tax-calculator-uk/) to check if the amount looks right.
...
Read our [National Insurance explained](/national-insurance-explained/) guide for full details on rates and thresholds.
...
Read our [pension auto-enrolment guide](/pension-auto-enrolment-uk-explained/) to understand how this works and why staying enrolled is almost always the right choice.
...
Source: [GOV.UK — Student loan repayments](https://www.gov.uk/repaying-your-student-loan).

### 9. Net Pay (Take-Home)
Your actual pay **after** all deductions. This is the amount that hits your bank account. Compare this with our [income tax calculator](/income-tax-calculator-uk/) to verify the figure.
...
If you spot an error, contact your employer's payroll department first, then HMRC if needed at [GOV.UK — Contact HMRC](https://www.gov.uk/contact-hmrc).
...
- [GOV.UK — Understanding your payslip](https://www.gov.uk/payslip)
- [ACAS — Pay and payslips](https://www.acas.org.uk/pay-and-payslips)
- See also: [Income Tax calculator](/income-tax-calculator-uk/), [Income Tax bands explained](/income-tax-bands-uk-explained/), [National Insurance explained](/national-insurance-explained/), [Pension auto-enrolment](/pension-auto-enrolment-uk-explained/)

> **Disclaimer:** This guide provides general information about UK payslips. Individual circumstances may vary. If you believe you've overpaid tax, contact HMRC or check [GOV.UK — Claim a tax refund](https://www.gov.uk/claim-tax-refund).