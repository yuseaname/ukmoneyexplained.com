...
1. **Topic research** — We identify the key questions people ask about a topic and gather data from primary sources.
2. **Outline creation** — Every article follows a consistent template: Quick Answer, Explanation, How It Works, Example Calculation, Reference Tables, and FAQs.
3. **Writing** — Content is written in plain English, targeting a reading age of 13-14 (the recommended level for public information). We avoid jargon and explain any technical terms.
4. **Fact-checking** — All figures, rates, thresholds, and percentages are verified against primary sources before publication.
5. **Review** — Content is reviewed for accuracy, clarity, and compliance with our editorial guidelines before publication.
...
If you spot an error in our content, please [contact us](/contact/) so we can investigate and correct it as quickly as possible.
