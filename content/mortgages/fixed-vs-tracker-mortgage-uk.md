...
1.  **Application:** You apply for a mortgage with a lender. You will be offered a choice of deals, including fixed and tracker options.
2.  **Selection:** You choose the term length. Fixed terms are often 2, 3, 5, or 10 years. Tracker terms can be similar but often have more flexibility.
3.  **Agreement:** You sign the mortgage offer. This document states the interest rate and the Early Repayment Charge (ERC) rules.
4.  **Completion:** The money is released to buy your home. Your first payment is calculated based on the agreed rate.
5.  **Duration:** During the term, a fixed rate stays the same. A tracker rate adjusts monthly based on the Bank of England.
6.  **End of Term:** When the deal ends, you move to the lender's Standard Variable Rate (SVR) unless you remortgage.
